...
words = {'Животные':'аист акула бабуин баран барсук бобр бык верблюд волк воробей ворон выдра голубь гусь'.split(),
        'Фигуры':'квадрат треугольник прямоугольник круг паралелограм паралелепипед трапецыя'.split(),
        'Цвета':'красный оранжевый жёлтый зелёный голубой синий фиолетовый розовый белый чёрный серый'.split(),
        'Фрукты':'яблоко апельсин мандарин груша банан кокос папая помэла манго дуриан мангостин'.split()}
...
while difficulty not in 'ЛСТ':
    print('Выберите уровень сложности: Л - легкий, С - средний, Сл - сложный')
